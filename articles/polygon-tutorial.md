...
Если вы уже готовили задачи в Polygon, то, скорее всего, вам будет неинтересно читать инструкцию по [подготовке задачи](#подготовка-задачи), поэтому в этом разделе приведены основные отличия от обычной подготовки задачи:
